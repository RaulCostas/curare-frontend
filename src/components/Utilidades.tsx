    ...
    return (
        <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen relative text-gray-800 dark:text-gray-200">
            <div className="flex items-center gap-4 mb-6">
                <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Utilidades</h1>
                <button
                                ...
                                <div className="sm:flex sm:items-start">
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                        ...
                                        <div className="mt-4">
                                            ...
                                            {(selectedDetail.title.includes('Egresos Diarios') || selectedDetail.title.includes('Pagos de Gastos Fijos')) && (
                                            ...
                                            <div className="max-h-96 overflow-y-auto">
                                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                    ...
                                                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                                        {(() => {
                                                            let itemsToDisplay = selectedDetail.items;
                                                            if (selectedDetail.title.includes('Egresos Diarios') || selectedDetail.title.includes('Pagos de Gastos Fijos')) {
                                                                itemsToDisplay = selectedDetail.items.filter(item => item.destino === activeTab);
                                                            }
