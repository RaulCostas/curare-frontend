        ...
        <div className="content-card bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 transition-colors duration-300">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 no-print gap-4">
                ...
                <div className="flex flex-wrap gap-2 justify-center md:justify-end">
                    ...
                    <button
                        onClick={() => navigate('/precios-laboratorios/create')}
                        ...
                        {Array.isArray(precios) && precios.map((precio, index) => (
                            <tr key={precio.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="px-5 py-4 whitespace-nowrap text-sm">
                                    <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${precio.estado === 'activo'
                                ...
                                <td className="px-5 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 no-print">
                                    <div className="flex gap-2">
                                        <button
                                            onClick={() => navigate(`/precios-laboratorios/edit/${precio.id}`)}
