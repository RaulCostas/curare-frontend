                                    ...
                                    <ul className="submenu-list" style={{ paddingLeft: '20px', listStyle: 'none', background: 'rgba(0,0,0,0.05)' }}>
                                        ...
                                        {hasAccess('pagos') && (
                                            <li className="nav-item">
                                                <Link
                                                    to="/pagos"
                                                    className={`nav-link ${isActive('/pagos')}`}
                                                    onClick={closeSidebar}
                                                    style={{ fontSize: '0.9em' }}
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px' }}>
                            ...
                            <li className="nav-item">
                                ...
                                >
                                    ...
                                    <svg
                                        ...
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                        style={{ transform: isConfigOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.3s' }}
                                    >
                                        <polyline points="6 9 12 15 18 9"></polyline>
                                    </svg>
                                </div>
                                {isConfigOpen && (
                                    <ul className="submenu-list" style={{ paddingLeft: '20px', listStyle: 'none', background: 'rgba(0,0,0,0.05)' }}>
                                        {hasAccess('config-categorias') && (
                                            <li className="nav-item">
                                                <Link
                                                    to="/categoria-paciente"
                                                    className={`nav-link ${isActive('/categoria-paciente')}`}
                                                    onClick={closeSidebar}
                                                    style={{ fontSize: '0.9em' }}
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px' }}>
                                        ...
                                        {hasAccess('config-chatbot') && (
                                            <li className="nav-item">
                                                <Link
                                                    to="/configuration/chatbot"
                                                    className={`nav-link ${isActive('/configuration/chatbot')}`}
                                                    onClick={closeSidebar}
                                                    style={{ fontSize: '0.9em' }}
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px' }}>
                                        ...
                                        {hasAccess('config-comision') && (
                                            <li className="nav-item">
                                                <Link
                                                    to="/comision-tarjeta"
                                                    className={`nav-link ${isActive('/comision-tarjeta')}`}
                                                    onClick={closeSidebar}
                                                    style={{ fontSize: '0.9em' }}
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px' }}>
                                        ...
                                        {hasAccess('config-especialidad') && (
                                            <li className="nav-item">
                                                <Link
                                                    to="/especialidad"
                                                    className={`nav-link ${isActive('/especialidad')}`}
                                                    onClick={closeSidebar}
                                                    style={{ fontSize: '0.9em' }}
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px' }}>
                                        ...
                                        {hasAccess('config-forma-pago') && (
                                            <li className="nav-item">
                                                <Link
                                                    to="/forma-pago"
                                                    className={`nav-link ${isActive('/forma-pago')}`}
                                                    onClick={closeSidebar}
                                                    style={{ fontSize: '0.9em' }}
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px' }}>
                                        ...
                                        {hasAccess('config-grupos') && (
                                            <li className="nav-item">
                                                <Link
                                                    to="/grupo-inventario"
                                                    className={`nav-link ${isActive('/grupo-inventario')}`}
                                                    onClick={closeSidebar}
                                                    style={{ fontSize: '0.9em' }}
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px' }}>
