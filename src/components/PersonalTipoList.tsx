                            ...
                            ${allAreas.map((area: PersonalTipo, index: number) => `
                                <tr>
                                    ...
                                    <td class="${area.estado === 'activo' ? 'status-active' : 'status-inactive'}">
                                        ${area.estado.charAt(0).toUpperCase() + area.estado.slice(1)}
                                    </td>
                                </tr>
                            `).join('')}
                        </tbody>
        ...
        <div className="content-card p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 no-print gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => navigate('/personal-tipo/create')}
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {Array.isArray(areas) && areas.map((area, index) => (
                            <tr key={area.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="p-4 text-gray-800 dark:text-gray-200">{area.area}</td>
                                <td className="p-4">
                                    <span className={`px-2 py-1 rounded-full text-xs font-semibold ${area.estado === 'activo'
                                ...
                                <td className="p-4 no-print text-center">
                                    <div className="flex justify-center gap-2">
                                        <button
                                            onClick={() => navigate(`/personal-tipo/edit/${area.id}`)}
