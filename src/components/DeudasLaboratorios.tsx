...
const DeudasLaboratorios: React.FC = () => {
    ...
    return (
        <div className="content-card">
            ...
            {/* Search Bar */}
            <div className="mb-6 flex flex-wrap gap-4 items-center justify-between bg-white p-4 rounded-xl shadow-sm border border-gray-100 no-print">
                <div className="relative flex-grow max-w-md">
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 text-gray-800 bg-white"
                    />
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {currentItems.map((work, index) => (
                            <tr key={work.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="p-3">
                                    <button
                                        onClick={() => navigate('/pagos-laboratorios/nuevo', { state: { workId: work.id } })}
