            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 no-print gap-4">
                ...
                <div className="flex flex-wrap gap-2 justify-center md:justify-end">
                    ...
                    <button
                        ...
                        className="bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg flex items-center justify-center shadow-md transition-all transform hover:-translate-y-0.5"
                    >
                        Volver
                    </button>
                    <Link
                                                ...
                                                {total > 0 ? (
                                                    <div className="flex flex-col items-center gap-1">
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-1 bg-gray-500 text-white rounded hover:bg-gray-600 shadow-md transition-all transform hover:-translate-y-0.5"
