        ...
        <div className="p-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 no-print gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => navigate('/comision-tarjeta/new')}
                        className="bg-[#3498db] hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition-all transform hover:-translate-y-0.5 flex items-center gap-2"
                    >
                        ...
                        {currentItems.map((comision, index) => (
                            <tr key={comision.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm flex gap-2 justify-center">
                                    <button
                                        onClick={() => navigate(`/comision-tarjeta/edit/${comision.id}`)}
