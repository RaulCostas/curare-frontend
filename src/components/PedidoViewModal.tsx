            ...
            <body>
                ...
                <div class="info-grid">
                    <div>
                        ...
                        <div class="info-item"><span class="label">Fecha:</span> ${new Date(pedido.fecha).toLocaleDateString()}</div>
                    </div>
                    <div>
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="bg-blue-50 dark:bg-gray-700 p-4 rounded-xl border border-blue-100 dark:border-gray-600 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-blue-900 dark:text-gray-200 shadow-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="font-semibold">{new Date(pedido.fecha).toLocaleDateString()}</span>
                                                </div>
                                                <div>
