...
const ProveedorList: React.FC = () => {
    ...
    const exportToExcel = async () => {
        try {
            ...
            const excelData = allProviders.map(provider => ({
                ...
                'Celular Contacto': provider.celular_contacto,
    ...
    const exportToPDF = async () => {
        try {
            ...
            doc.text('Lista de Proveedores', 50, 20);
                        ...
                        {providers.map((provider, index) => (
                            <tr key={provider.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="px-5 py-4 whitespace-nowrap text-sm">
                                    <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${provider.estado === 'activo'
                                ...
                                <td className="px-5 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 no-print">
                                    <div className="flex gap-2">
                                        <Link
                                            to={`/proveedores/edit/${provider.id}`}
